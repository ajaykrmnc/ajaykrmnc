     ...
     <Container>
      ...
      <Container style={{ marginBottom: '100px', marginTop: '60px', textAlign: 'center' }}>
        <Row style={{paddingTop: '30px'}}>
          <Col  md className='bottom'><h3>Trust Us With Your Harvest</h3><p className='hiddenText'>Get fair prices for your produce from Urban Reach</p></Col>
          <Col  md className='bottom'><h3>Direct From Farms to Your Business</h3><p className='hiddenText'>Get fair prices for your produce from Urban Reach</p></Col>
        </Row>
      </Container>
